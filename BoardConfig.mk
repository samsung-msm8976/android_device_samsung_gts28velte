...
# Kernel Prebuilt
TARGET_PREBUILT_KERNEL := device/samsung/gts28velte/kernel
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/gts28velte/mkbootimg.mk
...
BOARD_MKBOOTIMG_ARGS := --base 0x80000000 --ramdisk_offset 0x02000000 --tags_offset 0x01E00000 --board FPRPG21W000KU --dt device/samsung/gts28velte/dt.img
